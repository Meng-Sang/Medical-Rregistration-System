...
@WebServlet("/UnpaidInvestForSelfServlet")
public class UnpaidInvestForSelfServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int totalCount = new InvestServiceImpl().queryUnpaidInvestNumForSelf(username);
        pageUtil.init(1, 10, totalCount);
        request.getSession().setAttribute("pageUtil", pageUtil);
        response.sendRedirect("backstage/unpaidInvestForSelf.jsp");
    }
}
