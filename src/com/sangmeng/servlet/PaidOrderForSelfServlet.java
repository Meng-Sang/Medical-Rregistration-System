...
@WebServlet("/PaidOrderForSelfServlet")
public class PaidOrderForSelfServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int totalCount = new OrderServiceImpl().queryPaidOrderNumForSelf(username);
        pageUtil.init(1, 10, totalCount);
        request.getSession().setAttribute("pageUtil", pageUtil);
        response.sendRedirect("backstage/paidOrderForSelf.jsp");
    }
}
