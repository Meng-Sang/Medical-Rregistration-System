...
@WebServlet("/AllOrderForSelfServlet")
public class AllOrderForSelfServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            int totalCount = new OrderServiceImpl().queryTotalOrderNumForSelf(username);
