...
@WebServlet("/UnpaidInvestServlet")
public class UnpaidInvestServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int totalCount = new InvestServiceImpl().queryUnpaidInvestNum();
        pageUtil.init(1, 10, totalCount);
        request.getSession().setAttribute("pageUtil", pageUtil);
        response.sendRedirect("backstage/unpaidInvest.jsp");
    }
}
