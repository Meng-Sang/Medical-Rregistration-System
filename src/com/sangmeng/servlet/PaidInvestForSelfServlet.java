...
@WebServlet("/PaidInvestForSelfServlet")
public class PaidInvestForSelfServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int totalCount = new InvestServiceImpl().queryPaidInvestNumForSelf(username);
        pageUtil.init(1, 10, totalCount);
        request.getSession().setAttribute("pageUtil", pageUtil);
        response.sendRedirect("backstage/paidInvestForSelf.jsp");
    }
}
