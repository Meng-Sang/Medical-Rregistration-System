...
@WebServlet("/AccessAddIdInformationServlet")
public class AccessAddIdInformationServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        response.sendRedirect("backstage/addIdInformation.jsp");
    }
}
