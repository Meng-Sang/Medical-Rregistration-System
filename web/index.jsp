...
<body>
  ...
  <div id="center" class="container">
    <div class="container changeMagin">
      <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="item active">
            <img src="img/collapse1.jpg" alt="">
          </div>
          <div class="item">
            <img src="img/collapse2.jpg" alt="...">
          </div>
          <div class="item">
            <img src="img/collapse3.jpg" alt="...">
          </div>
          <div class="item">
            <img src="img/collapse4.jpg" alt="...">
          </div>
          <div class="item">
            <img src="img/collapse5.jpg" alt="...">
          </div>
        </div>
