...
<head>
  ...
  <link rel="stylesheet" href="css/doctorinformation/style.css"/>
  <!--[if lt IE 9]>
...
<body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="administrativeInformation.jsp">挂号服务<span class="sr-only">(current)</span></a></li>
  ...
  <div id="center" class="container">
    <div class="container outdoctor changeMagin">
      <div class="row">
        <sms:outdoctor></sms:outdoctor>
      </div>
    </div>
  </div>
