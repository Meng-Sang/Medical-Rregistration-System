                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                            <div id="my_invest">
                                <sms:outInvest per="unpaid" ></sms:outInvest>
                            </div>
                            </tbody>
                        </table>
                        <div>
...
<script type="text/javascript">
    $(function(){
        ...
        $(".investRow").each(
            function () {
                var investNumber = $(this).children(".investNumber").text();
                $(this).find(".completePay>a").click(
                    function () {
                        var $completePay = $(this);
                        if(confirm("是否进行充值")) {
                            $.post("../PaymentServlet", {investNumber: investNumber,charge_option:"invest"}, function (data) {
                                if (data == "1") {
                                    alert("充值成功");
                                    $completePay.text("已支付");
                                    return;
                                } else if (data == "0") {
                                    if (confirm("充值失败，是否返回首页")) {
