                    ...
                    <div class="col-xs-12">
                        ...
                        <div>
                            <table class="table table-hover">
                                ...
                                <tbody>
                                <div id="my_invest">
<%--                                    <tr class="backDoctorRow"><td>1</td><td>root</td><td>预防保健科</td><td>4</td><td>桑蒙</td><td>56+55+6</td><td>医师</td><td class="root">通过</td></tr><tr class="backDoctorRow"><td>2</td><td>team4951</td><td>预防保健科</td><td>12</td><td>桑蒙</td><td>4566</td><td>医师</td><td class="team4951">通过</td></tr><tr class="backDoctorRow"><td>3</td><td>123</td><td>小儿科</td><td>12</td><td>桑蒙</td><td>4564</td><td>专家</td><td class="123"><span class="glyphicon glyphicon-ok" id="approve" style="color: green; margin-right: 20%"></span><span class="glyphicon glyphicon-remove" id="disapprove" style="color: red;"></span></td></tr><tr class="backDoctorRow"><td>4</td><td>123456</td><td>急诊科</td><td>10000001</td><td>桑蒙</td><td></td><td>医师</td><td class="123456">未通过</td></tr><tr class="backDoctorRow"><td>5</td><td>sangmeng</td><td>预防保健科</td><td>10000001</td><td>桑蒙</td><td></td><td>专家</td><td class="sangmeng">未通过</td></tr>--%>
                                    <sms:outDoctors></sms:outDoctors>
                                </div>
                                </tbody>
                            </table>
                            <div>
...
<script type="text/javascript">
    $(function(){
        ...
        $(".backDoctorRow").each(
            function () {
                var $audited = $(this).find("#approve");
                $audited.click(
                    function () {
                        if(confirm("是否将审批状态该改为通过！！！")) {
                            var $state = $(this);
                            var user = $state.parent().attr("class");
                            $.post("../UpdateDoctorServlet",
                                {option: "audited", user: user},
                                function (data) {
                                    if (data == "ok") {
                                        $state.parent().html("通过");
                                        return;
                                    } else {
                                        alert("审批失败请重新操做");
                                        return;
                ...
                var $audit = $(this).find("#disapprove");
                $audit.click(
                    function () {
                        if(confirm("是否将审批状态该改为未通过！！！")){
                            var $state = $(this);
                            var user = $state.parent().attr("class");
                            $.post("../UpdateDoctorServlet",
                                {option:"audit",user:user},
                                function (data) {
                                    if(data=="ok")
                                    {
                                        $state.parent().html("未通过");
                                        return;
                                    }else {
                                        alert("审批失败请重新操做");
                                        return;
