                            ...
                            <div class="container InputIdInformation">
                                ...
                                <form class="form-horizontal">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"  class="form-control" readonly value="${requestScope.doctor.name}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">工号：</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" readonly value="${requestScope.doctor.sno}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">选择科室：</label>
                                        <div class="col-sm-2">
                                            ${requestScope.doctor.ad_name}
                                        </div>
                                        <label class="col-sm-2 control-label">我是：</label>
                                        <div class="col-sm-2">
                                            <c:if test="${requestScope.doctor.level eq 'profession'}">专家</c:if>
                                            <c:if test="${requestScope.doctor.level eq 'ordinary'}">医师</c:if>
                                        </div>
                                        <label class="col-sm-2 control-label">审核状态：</label>
                                        <div class="col-sm-2">
                                            <c:if test="${requestScope.doctor.audit eq 'audited'}">已审核</c:if>
                                            <c:if test="${requestScope.doctor.audit eq 'audit'}">未通过</c:if>
                                            <c:if test="${requestScope.doctor.audit eq ''}">待审核</c:if>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label  class="col-sm-3 control-label">自我介绍：</label>
                                        <div class="col-sm-9">
                                            <textarea  style="width: 100%;height: 200px;resize: none" readonly>${requestScope.doctor.self_introduction}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">个人照片：</label>
                                        <div class="col-sm-5">
                                            <img src="${ctx}/upload/doc_photo/${requestScope.doctor.photo}">
                                        </div>
                                    </div>
                                    <div class="form-group">
