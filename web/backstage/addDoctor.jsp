                    ...
                    <div class="col-xs-12">
                        ...
                        <div style="width: 60%">
                            <div class="container InputIdInformation">
                                <h2 class="text-center col-lg-9 col-sm-offset-3">欢迎用户${username}登记添加医生身份</h2>
                                <form class="form-horizontal" id="form1" method="post" enctype = "multipart/form-data">
                                    <div class="form-group">
                                        <label for="user" class="col-sm-3 control-label">医生账号：</label>
                                        <div class="col-sm-9">
                                            <input id="user" type="text" name="user" class="form-control"  placeholder="医生账号">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group" name="form">
                                        ...
                                        <div class="col-sm-3">
                                            <select id="level" name="level" class="form-control">
                                                <option value="ordinary" selected>医师</option>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-3 col-sm-3">
                                            <button type="submit" id="commit"  class="btn btn-default" >提交</button>
                                        </div>
                                        <div class="col-sm-offset-3 col-sm-3">
